...
class StructuredConversationalAgent_Agents implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        ...
        this.description = 'Structured conversational agent for a chat model. It will utilize chat specific prompts'
...
module.exports = { nodeClass: StructuredConversationalAgent_Agents }
